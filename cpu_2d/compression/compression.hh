...
public:
    ...
    virtual void compress(T *fq_64, const int32_t size, T_C **compressed_fq_64, size_t &compressedsize) const = 0;
    virtual void decompress(T_C *compressed_fq_64, const size_t size,

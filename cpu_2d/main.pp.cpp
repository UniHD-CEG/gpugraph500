...
int main(int argc, char** argv)
{
      ...
      MPI_Bcast(&scale     ,1,((MPI_Datatype) ((void *) &( ompi_mpi_int64_t))),0,(( MPI_Comm) ((void *) &( ompi_mpi_comm_world))));
      MPI_Bcast(&edgefactor,1,((MPI_Datatype) ((void *) &( ompi_mpi_int64_t))),0,(( MPI_Comm) ((void *) &( ompi_mpi_comm_world))));
      MPI_Bcast(&num_of_iterations,1,((MPI_Datatype) ((void *) &( ompi_mpi_int64_t))),0,(( MPI_Comm) ((void *) &( ompi_mpi_comm_world))));
      MPI_Bcast(&R         ,1,((MPI_Datatype) ((void *) &( ompi_mpi_int))),0,(( MPI_Comm) ((void *) &( ompi_mpi_comm_world))));
      MPI_Bcast(&C         ,1,((MPI_Datatype) ((void *) &( ompi_mpi_int))),0,(( MPI_Comm) ((void *) &( ompi_mpi_comm_world))));
      #ifdef 1
      MPI_Bcast(&gpus      ,1,((MPI_Datatype) ((void *) &( ompi_mpi_int))),0,(( MPI_Comm) ((void *) &( ompi_mpi_comm_world))));
      MPI_Bcast(&queue_sizing,1,((MPI_Datatype) ((void *) &( ompi_mpi_double))),0,(( MPI_Comm) ((void *) &( ompi_mpi_comm_world))));
      #endif
      MPI_Bcast(&verbosity ,1,((MPI_Datatype) ((void *) &( ompi_mpi_int64_t))),0,(( MPI_Comm) ((void *) &( ompi_mpi_comm_world))));
      ...
      MPI_Reduce(&number_of_edges, &global_edges_wd, 1, ((MPI_Datatype) ((void *) &( ompi_mpi_long))), ((MPI_Op) ((void *) &( ompi_mpi_op_sum))), 0, (( MPI_Comm) ((void *) &( ompi_mpi_comm_world))));
      ...
      MPI_Reduce(&local_edges, &global_edges, 1, ((MPI_Datatype) ((void *) &( ompi_mpi_long))), ((MPI_Op) ((void *) &( ompi_mpi_op_sum))), 0, (( MPI_Comm) ((void *) &( ompi_mpi_comm_world))));
...
*/
      ...
      if(rank == 0){
          ...
          while(iterations < num_of_iterations && giteration < num_of_iterations*maxgenvtx){
            ...
            int next =1;
            MPI_Bcast(&next,1,((MPI_Datatype) ((void *) &( ompi_mpi_int))),0,(( MPI_Comm) ((void *) &( ompi_mpi_comm_world))));
            // test if vertex has edges to other vertices
            long elem = 0;
            MPI_Bcast(&start,1,((MPI_Datatype) ((void *) &( ompi_mpi_long))),0,(( MPI_Comm) ((void *) &( ompi_mpi_comm_world))));
            ...
            MPI_Reduce(((void *) 1), &elem, 1, ((MPI_Datatype) ((void *) &( ompi_mpi_long))), ((MPI_Op) ((void *) &( ompi_mpi_op_sum))), 0, (( MPI_Comm) ((void *) &( ompi_mpi_comm_world))));
          ...
          MPI_Bcast(&next,1,((MPI_Datatype) ((void *) &( ompi_mpi_int))),0,(( MPI_Comm) ((void *) &( ompi_mpi_comm_world))));
           ...
           while(true){
            ...
            MPI_Reduce(&elem, &elem, 1, ((MPI_Datatype) ((void *) &( ompi_mpi_long))), ((MPI_Op) ((void *) &( ompi_mpi_op_sum))), 0, (( MPI_Comm) ((void *) &( ompi_mpi_comm_world))));

          }
      }
      MPI_Bcast(&iterations,1,((MPI_Datatype) ((void *) &( ompi_mpi_int))),0,(( MPI_Comm) ((void *) &( ompi_mpi_comm_world))));
      ...
      for(int i=0; i < iterations; i++){
          ...
          MPI_Reduce(&lexp, &gmax_lexp, 1, ((MPI_Datatype) ((void *) &( ompi_mpi_double))), ((MPI_Op) ((void *) &( ompi_mpi_op_max))), 0, (( MPI_Comm) ((void *) &( ompi_mpi_comm_world))));
          MPI_Reduce(&lqueue, &gmax_lqueue, 1, ((MPI_Datatype) ((void *) &( ompi_mpi_double))), ((MPI_Op) ((void *) &( ompi_mpi_op_max))), 0, (( MPI_Comm) ((void *) &( ompi_mpi_comm_world))));
          MPI_Reduce(&rowcom, &gmax_rowcom, 1, ((MPI_Datatype) ((void *) &( ompi_mpi_double))), ((MPI_Op) ((void *) &( ompi_mpi_op_max))), 0, (( MPI_Comm) ((void *) &( ompi_mpi_comm_world))));
          MPI_Reduce(&colcom, &gmax_colcom, 1, ((MPI_Datatype) ((void *) &( ompi_mpi_double))), ((MPI_Op) ((void *) &( ompi_mpi_op_max))), 0, (( MPI_Comm) ((void *) &( ompi_mpi_comm_world))));
          MPI_Reduce(&predlistred, &gmax_predlistred, 1, ((MPI_Datatype) ((void *) &( ompi_mpi_double))), ((MPI_Op) ((void *) &( ompi_mpi_op_max))), 0, (( MPI_Comm) ((void *) &( ompi_mpi_comm_world))));
          #endif

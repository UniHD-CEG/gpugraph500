...
# Generated by qmake (3.0) (Qt 5.0.2) on: Mi. Feb. 26 01:36:11 2014
# Project:  g500.pro
# Template: app
...
CXX           = mpicxx
DEFINES       = 
CFLAGS        = -m64 -pipe -std=c99 -fopenmp -O2 -O3 -Wall -W -fPIE $(DEFINES)
CXXFLAGS      = -m64 -pipe -fopenmp -DINSTRUMENTED -O2 -O3 -Wall -W -fPIE $(DEFINES)
